/*
 *
 * CorporatePartnershipsMainDashContainer reducer
 *
 */
...
function corporatePartnershipsMainDashContainerReducer(state = initialState, action) {
  switch (action.type) {
...
export default corporatePartnershipsMainDashContainerReducer;
